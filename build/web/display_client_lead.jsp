        ...
        <table class="table table-bordered">
            ...
            <%
                try{
                    ...
                    String sql="select * from client_enquiry where status=('lead') order by CLIENT_ID desc";
                    ...
                    while(rs.next())
                    {
                        ...
                        <tr>
                            ...
                            <td align="center">
                                <a href="display_delete_client_lead.jsp?id=<%=rs.getInt("CLIENT_ID")%>">
                                <button class="btn btn-info">
                            ...
                            <td align="center">
                                <a href="display_update_process_client_lead.jsp?id=<%=rs.getInt("CLIENT_ID")%>">
                                    <button class="btn btn-info">
