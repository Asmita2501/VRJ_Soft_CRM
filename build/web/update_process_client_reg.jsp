...
<%
    ...
    try{
        ...
        String sql ="select * from client_registration where CLIENT_ID=" +id;
        ...
        while(rs.next())
        {
          ...
          <html> 
              <body>
          <form name="f1" action="update_registration.jsp" method="POST">
    		<h3 class="text-center">Update Client Registration</h3>
    		<div class="form-group">
                ...
                <div class="form-group">
                    Registration Date:
                    <input type="text" name="reg_date"  class="form-control" value="<%=rs.getString("REG_DATE")%>">
    		</div>
    		...
    		<div class="form-group">
                ...
                <div class="form-group">
                    Company Name:
    			<input type="text" name="c_name" class="form-control" value="<%=rs.getString("COMPANY_NAME")%>">
    		</div>
                
                <div class="form-group">
                    Company Address:
    			<input type="text" name="c_address" class="form-control" value="<%=rs.getString("COMPANY_ADDRESS")%>">
    		</div>

    		<div class="form-group text-center">
    			<button class="btn btn-info">Go To Dashboard</button>
                <button class="btn btn-info" type="submit" onclick="return validation()">Update Registration</button>
