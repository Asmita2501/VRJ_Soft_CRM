...
<style type="text/css">
    ...
    <body>
        ...
        <div class="row">
            ...
            <div>
                <h3>CLIENT FOLLOW UP DETAILS</h3>
            </div>
        </div><!--end of row-->
        ...
        <table class="table table-bordered">
            ...
            <%
                try{
                    ...
                    String sql="select * from client_enquiry where(status ='followUp') order by CLIENT_ID desc";
                    ...
                    while(rs.next())
                    {
                        ...
                        <tr>
                            ...
                            <td> <%=rs.getString("CLIENT_INFORMATION")%> </td>
                            <td> <%=rs.getString("CLIENT_SUGGESTED_INFORMATION")%> </td>
                            <td> <%=rs.getString("STATUS")%> </td>
                            
                            <td align="center">
                                <a href="display_delete_client_followup.jsp?id=<%=rs.getInt("CLIENT_ID")%>">
                                <button class="btn btn-info">
                            ...
                            <td align="center">
                                <a href="display_update_process_client_followup.jsp?id=<%=rs.getInt("CLIENT_ID")%>">
                                    <button class="btn btn-info">
