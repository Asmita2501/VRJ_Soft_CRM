...
<style type="text/css">
    ...
    <body>
        ...
        <div class="row">
            ...
            <div>
                <h3 style="text-center">CLIENT ENQUIRY DETAILS</h3>
            </div>
        </div><!--end of row-->
    ...
    <center>
        <table class="table table-bordered">
            <tr bgcolor="gold">
                ...
                <th>Client Suggested Information</th>
                <th>Status</th>
            ...
            <%
                try{
                    ...
                    while(rs.next())
                    {
                       ...
                       <td align="center">
                           <a href="delete_enquiry.jsp?id=<%=rs.getInt("CLIENT_ID")%>">
                               <button class="btn btn-info">
                       ...
                       <td align="center">
                           <a href="update_process_enquiry.jsp?id=<%=rs.getInt("CLIENT_ID")%>">
                               <button class="btn btn-info">
